...
export function MobileParentDashboardContent() {
  ...
  const activeChild = data?.children.find(
    (c) => c.child.id === selectedChild,
  );
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-sm text-muted-foreground truncate">
                          {activeChild.child.profile?.school ??
                            "Belum diisi"}{" "}
                          ·{" "}
                          {activeChild.child.profile?.targetExam ??
                            "Belum ditentukan"}
                        </p>
                        <p className="text-xs text-muted-foreground">
                          Terakhir aktif:{" "}
          ...
          !data?.pendingInvites?.length && (
            <div className="flex flex-col items-center py-16 text-center">
              ...
              <p className="text-sm text-muted-foreground">
                Belum ada anak yang ditautkan. Masukkan email akun anak untuk
                mulai monitoring.
              </p>
            </div>
          )}
