...
function MenuItem({ href, icon, label }: MenuItemProps) {
  return (
    <Link
      href={href}
      className="flex min-h-12 items-center gap-3 px-4 py-3 transition-colors hover:bg-muted/30 active:bg-muted/50"
    >
  ...
  return (
    <div className="mx-auto max-w-lg px-4 pb-24 pt-6 md:pb-8">
      ...
      >
        <button
          type="submit"
          className="flex min-h-12 w-full items-center gap-3 rounded-2xl px-4 py-3 text-red-600 transition-colors hover:bg-red-50 active:bg-red-50"
        >
