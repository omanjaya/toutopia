...
export const studentNav: NavItem[] = [
  ...
  { title: "Notifikasi", href: "/dashboard/notifications", icon: "Bell", group: "Akun" },
  { title: "Planner", href: "/dashboard/planner", icon: "CalendarDays", group: "Akun" },
  { title: "Jadi Pengajar", href: "/dashboard/become-teacher", icon: "GraduationCap", group: "Akun" },
...
export const teacherNav: NavItem[] = [
  ...
  { title: "Import Soal", href: "/teacher/questions/import", icon: "Upload" },
...
export const adminNav: NavItem[] = [
  ...
  { title: "Topik", href: "/admin/topics", icon: "CircleDot" },
  ...
  { title: "Kredit", href: "/admin/credits", icon: "Coins" },
